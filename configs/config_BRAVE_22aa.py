...
data_dir_save = "Brave_22aa"
data_dir = "Brave"
# Define the directory where the logs are stored
log_dir = data_dir_save + "/logs/"
...
config_S1 = {
    ...
    "output_csv": data_dir_save + "/LUT.csv",
    "output_name": data_dir_save + "/SortedFragments.txt",
    "log_dir": log_dir,
}
...
config_S2 = {
    ...
    "out_dir": data_dir_save + "/barcode_fragment",
...
config_S4 = {
    ...
    "bc_len": bc_len,
    "db": data_dir_save + "/barcode_db.fasta",
    ...
    "log_file_path": data_dir_save + "/found_barcode_report.csv",
    # output directory for the found barcodes csv files
    "output_dir": data_dir_save + "/found_barcodes",
...
config_S5 = {
    ...
    "output_table": data_dir_save + "/pos_library_barcodes.csv",
    "log_dir": log_dir,
}
...
config_S6 = {
    ...
    "output_table": data_dir_save + "/final_fragments_summary.csv",
    "log_dir": log_dir,
}
